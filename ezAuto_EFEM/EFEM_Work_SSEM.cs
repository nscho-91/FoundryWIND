...
{
    class EFEM_Work_SSEM : Work_Mom, Control_Child
    {
        ...
        public override void Init(string id, object auto)
        {
            ...
            m_swDoorFan.Start();
            RunGrid(eGrid.eInit);
            m_GEM300_SSEM = new Gem_SSEM((Auto_Mom)m_auto);
            InitTimer();
        }
        ...
        public void ControlGrid(Control_Mom control, ezGrid rGrid, eGrid eMode)
        {
            ...
            control.AddDI(rGrid, ref m_diDoorFan[3], m_id, "VS PC Door Fan", "LightCurtain");
            control.AddDI(rGrid, ref m_diDoorFan[4], m_id, "VS Top Door Fan", "LightCurtain");
            control.AddDI(rGrid, ref m_diDoorFan[5], m_id, "VS Bot Door Fan", "LightCurtain");
            control.AddDI(rGrid, ref m_diEMO[0], m_id, m_strEMOs[0], m_strEMOs[0]);
            control.AddDI(rGrid, ref m_diEMO[1], m_id, m_strEMOs[1], m_strEMOs[1]);
            control.AddDI(rGrid, ref m_diEMO[2], m_id, m_strEMOs[2], m_strEMOs[2]);
            control.AddDI(rGrid, ref m_diEMO[3], m_id, m_strEMOs[3], m_strEMOs[3]);
            control.AddDI(rGrid, ref m_diEMS[0], m_id, m_strEMSs[0], m_strEMSs[0]);
            control.AddDI(rGrid, ref m_diEMS[1], m_id, m_strEMSs[1], m_strEMSs[1]);
            control.AddDI(rGrid, ref m_diEMS[2], m_id, m_strEMSs[2], m_strEMSs[2]);
            control.AddDI(rGrid, ref m_diEMS[3], m_id, m_strEMSs[3], m_strEMSs[3]);
        }
                ...
                if (m_diDoor[n] >= 0 && !m_control.GetInputBit(m_diDoor[n]))
                {
                    switch (n)
                    {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            m_strDoorName = "EFEM Top Electric Door";
                            break;
                        case 3:
                            m_strDoorName = "EFEM Bottom Electric Door";
                            break;
                        case 4:
                ...
                if (m_diDoorVision[n] >= 0 && !m_control.GetInputBit(m_diDoorVision[n]))
                {
                    switch (n)
                    {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            m_strDoorName = "Vision Module Top Electric Door";
                            break;
                        case 3:
                            m_strDoorName = "Vision Module Bottom Electric Door";
                            break;
                        case 4:
        ...
        public override void RunLamp()
        {
            ...
            if (IsDoorOpen() && m_swDoor.Check() > 10000)      //20160905 SDH DoorSensor Run안할때도 체크되도록
            {
        ...
        public override object GetSSEMGEM()
        {
            return m_GEM300_SSEM;
        }
